## CS50 outdated problem
## A program that prompts the user for a date, the program takes that date and outputs the date in YYYY-MM-DD format

## define main
def main():

    ## Create list with the names on the months
    months = [
        "January",
        "February",
        "March",
    ...
    ## if month is less th 10 add a 0 before
